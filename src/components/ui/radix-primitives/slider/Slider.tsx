  ...
  (props: ScopedProps<SliderProps>, forwardedRef) => {
    ...
    function updateValues(value: number, atIndex: number, { commit } = { commit: false }) {
      ...
      setValues((prevValues = []) => {
        // Thumb が交差しないようにする
        if (!isNextValuesAlreadySorted(prevValues, nextValue, atIndex)) {
          return prevValues
        }
...
function isNextValuesAlreadySorted(prevValues: number[], nextValue: number, atIndex: number) {
  const nextValues = [...prevValues]
  nextValues[atIndex] = nextValue
  return String(nextValues) === String(nextValues.sort((a, b) => a - b))
}
